...
🎓 Final-Year B.Tech Artificial Intelligence & Data Science &nbsp;|&nbsp; 📍 Mumbai, Maharashtra, India
...
**AI / ML** &nbsp; `Machine Learning` `Scikit-learn` `Regression` `Classification`
...
| Certificate | Issuer |
|---|---|
| 🏅 AI & Data Science Internship | Future Interns |
| 🏅 Python Programming | NPTEL / Coursera |
